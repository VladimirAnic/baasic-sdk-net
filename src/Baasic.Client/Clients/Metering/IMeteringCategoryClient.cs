...
{
    /// <summary>
    /// Categories Metering Module Client.
    /// </summary>
    public interface IMeteringCategoryClient<T> where T : IModel
    {
        ...
        Task<CollectionModelBase<T>> FindAsync(string searchQuery = ClientBase.DefaultSearchQuery, int page = ClientBase.DefaultPage, int rpp = ClientBase.DefaultMaxNumberOfResults, string sort = ClientBase.DefaultSorting, string embed = ClientBase.DefaultEmbed);
        ...
        Task<CollectionModelBase<T>> FindAsync<T>(string searchQuery = ClientBase.DefaultSearchQuery,
            ...
            string sort = ClientBase.DefaultSorting, string embed = ClientBase.DefaultEmbed) where T : IModel;
        ...
        Task<T> GetAsync(object id, string embed = ClientBase.DefaultEmbed);
